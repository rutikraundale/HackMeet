              ...
              {filteredUsers.length > 0 ? (
                filteredUsers.map((u) => (
                  <div
                    ...
                    className="p-2 hover:bg-gray-700 cursor-pointer rounded flex items-center gap-3"
                  >
                    {u.profilePicture ? (
        ...
        {loading ? (
          ...
          conversations.map((conv) => (
            <div
              ...
              className={`cursor-pointer p-3 rounded-lg mb-2 flex items-center gap-3 transition ${
            ...
            >
              {conv.user?.profilePicture ? (
                <img src={conv.user.profilePicture} alt="" className="w-10 h-10 rounded-full object-cover" />
              ) : (
              ...
              <div className="flex-1 min-w-0">
                <p className="text-white font-medium text-sm">{conv.user?.username}</p>
